      ...
      <el-aside width="200px">
        ...
        >
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-1" class="el-icon-user">&nbsp;用户列表</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">
          ...
          <el-submenu index="3">
            ...
            <el-menu-item-group>
              <el-menu-item index="3-1" class="el-icon-chat-line-square">&nbsp;栏目列表</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
      </el-aside>
